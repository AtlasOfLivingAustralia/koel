...
test_that("identify_shape() behaves as intended for various inputs", {
  ...
  expect_equal(____, nrow(is_output |> filter(shape_feature == "Lord Howe Island")))
  ...
  is_output <- identify_shape(species_records, shapes_path)
  expect_equal(____, nrow(is_output |> filter(shape_feature == "lord_howe")))
...
test_that("identify_shape() behaves as intended for various inputs", {
  ...
  is_output <- identify_shape(species_records, shapes_path)
  expect_equal(____, nrow(is_output |> filter(shape_feature == "Lord Howe Island")))
  expect_equal(____, nrow(is_output |> filter(shape_feature == "Tasmania")))
})
